...
if __name__ == "__main__":
    ...
    params_df = pd.read_csv("/home/tadas/code/deltaproteinsBristol/experimental_results/deltaprot_designs_data_with_results.csv")[["Well Position","cd_path_length_mm",
 "cd_sample_molar_conc","sequence_length"]]
    ...
    files = {
        ...
        "A9_remelt": "20250404_1mm_BP-Buffer_A9_melt@.txt", # Cooling curve
        ...
        "A12_remelt": "20250404_1mm_BP-Buffer_A12_melt@.txt", # Cooling curve
        ...
        "A1_remelt": "20250404_1mm_BP-Buffer_A1_melt@.txt", # Cooling curve
        ...
        "B12_remelt": "20250404_1mm_BP-Buffer_B12_melt@.txt", # Cooling curve
        ...
        "F4_remelt": "20250404_1mm_BP-Buffer_F4_melt@.txt", # Cooling curve
